...
class LoadDataset(torch.utils.data.Dataset):
    def __init__(self,datasetpath,pairpath,scencelist,nviews):
    ...
    def __getitem__(self, item):
        ...
        for vid in rs_views:
            img_filename = get_img_path(self.datasetpath, scan_folder, vid, lighting=None, mode="eval")
            cam_filename = get_cam_path(self.datasetpath, scan_folder, vid, mode="eval")

            imgs.append(data_io.read_img(img_filename)[:1184])
