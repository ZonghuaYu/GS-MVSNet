...
class LoadDataset(torch.utils.data.Dataset):
    def __init__(self, datasetpath, scenelist, nviews):
    ...
    def __getitem__(self, item):
        ...
        for vid in rs_views:
            img_filename = get_img_path(self.datasetpath, scan_folder, vid, lighting=None, mode="tanks")
            cam_filename = get_cam_path(self.datasetpath, scan_folder, vid, mode="tanks")

            imgs.append(data_io.read_img(img_filename)[:1056]) #(2048/1920,1080)->(2048/1920,1056)
