...
dataPath='..\MVS Data\';
plyPath='..\MVS Data\Points\gsmvsnet\';
resultsPath='..\MVS Data\Results\';

method_string='gsmvsnet';
...
switch representation_string
    case 'Points'
        eval_string='_Eval_'; %results naming %_Eval_IJCV_
        settings_string='';
end
...
fprintf("final evaluation result on all scans mean: acc.: %f, comp.: %f, overall: %f\n", mean_result(1), mean_result(3), (mean_result(1)+mean_result(3))/2);
fprintf("final evaluation result on all scans median: acc.: %f, comp.: %f, overall: %f\n", mean_result(2), mean_result(4), (mean_result(2)+mean_result(4))/2);
