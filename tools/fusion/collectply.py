...
def moves(args):
    ...
    for scan in scans:
        ...
        if args.dataset == "dtu":
            scan_idx = int(scan[4:])
            target_ply = os.path.join(args.collect_folder, 'gsmvsnet{:03d}_l3.ply'.format(scan_idx))
        elif args.dataset == "tanks":
...
if __name__ == '__main__':
    ...
    parser.add_argument("-c", '--collect_folder', default="/hy-tmp/gsmvsnet/", type=str, help='')   #"../../gsmvsnet"
